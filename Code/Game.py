...
def lvl(screen,nlvl):
    ...
    while True:
        ...
        lower_blue = np.array([l_h, l_s, l_v])                                                              #parte "bassa" del range dei colori (colore più scuro)
        upper_blue = np.array([u_h, u_s, u_v])                                                              #parte "alta" del range dei colori (colore più chiaro)
...
def start(screen,nlvl):
    ...
    while True:
        ...
        if x > 240 and x < 360 and y > 200 and y < 280:                                                     #se l'oggetto è posizionato al centro, quindi in posizione corretta, stampa OK
            ...
            screen.blit(no, centerTitle2)                                                                   #se l'oggetto non è posizionato al centro, quindi non in posizione corretta, stampa NO
            waitTime=0
...
def level(screen):
    ...
    while True:
        if music == 0:
            pygame.mixer.Sound.set_volume(soundMenu,0.5)                                                    #Se non vi è già, fa partire la musica del menu
